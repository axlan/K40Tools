...
class MyApp(App):
    def __init__(self, *args):
        ...
        super(MyApp, self).__init__(*args, static_file_path={'my_resources':res_path, 'output':working_path})
    ...
    def print_job(self):
        try:
            ...
            print(traceback.format_exc())
            inputDialog = gui.GenericDialog('Print Error', traceback.format_exc())
